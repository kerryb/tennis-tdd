defmodule TennisScorer.Game do
  ...
  defp advantage_player_one?(game), do: game.player_one_score - game.player_two_score == 1

  defp advantage_player_two?(game), do: game.player_two_score - game.player_one_score == 1
